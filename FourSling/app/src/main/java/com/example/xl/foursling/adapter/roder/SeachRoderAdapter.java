 ...
 */
public class SeachRoderAdapter extends BaseAdapter{
    private Context context;
    private RoderOnClickLister roderOnClickLister;
    private List<SeachRoderUnity.MessageBean.RowsBean> message;
    public SeachRoderAdapter(Context context, List<SeachRoderUnity.MessageBean.RowsBean> message,RoderOnClickLister roderOnClickLister) {
