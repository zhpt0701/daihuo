...
public class SwicthView extends View implements View.OnTouchListener {
    ...
    public void init(){
        //载入图片资源
        bg_on = BitmapFactory.decodeResource(getResources(), R.mipmap.on_roundedrectangle);
        bg_off = BitmapFactory.decodeResource(getResources(), R.mipmap.off_switchbackground);
        slipper_btn = BitmapFactory.decodeResource(getResources(), R.mipmap.handle);
