...
public class AppMailException extends Exception implements Thread.UncaughtExceptionHandler {
    public static final String TAG = "AppException";

    // 系统默认的UncaughtException处理类
    private Thread.UncaughtExceptionHandler mDefaultHandler;
    // AppException实例
    private static AppMailException INSTANCE = new AppMailException();
    // 程序的Context对象
    ...
    private AppMailException() {
    }

    /** 获取AppException实例 ,单例模式 */
    public static AppMailException getInstance() {
        return INSTANCE;
    }
        ...
        new Thread() {
            public void run() {
                ...
                mail.sendEmail(
                        "1303388608@qq.com",
                        "i带货app崩溃日志（"
                                + StringUilts.transfromTime(System
