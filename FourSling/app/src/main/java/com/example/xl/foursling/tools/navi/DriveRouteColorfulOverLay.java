package com.example.xl.foursling.tools.navi;
...
public class DriveRouteColorfulOverLay {
    ...
    private BitmapDescriptor getStartBitmapDescriptor() {
		return BitmapDescriptorFactory.fromResource(R.mipmap.search_icon_start);
	}
	/**
    ...
    private BitmapDescriptor getEndBitmapDescriptor() {
		return BitmapDescriptorFactory.fromResource(R.mipmap.search_icon_end);
	}
